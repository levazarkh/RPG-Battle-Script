...
# Instantiate People
player1 = Person("Valos:", 3260, 150, 300, 34, player_spells, player_items)
player2 = Person("Nick: ", 4160, 150, 320, 34, player_spells, player_items)
player3 = Person("Robot:", 4000, 150, 312, 34, player_spells, player_items)

enemy1 = Person("Imp1  ", 1250, 130, 560, 325, enemy_spells, [])
enemy2 = Person("Levis ", 18200, 700, 500, 25, enemy_spells, [])
...
while running:
    ...
    for player in players:
        ...
        if index == 0:
            ...
            print("You attacked for " + enemies[enemy].name.replace(" ", ""), dmg, "points of damage")
